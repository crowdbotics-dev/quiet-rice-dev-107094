"""
Django settings for quiet_rice_dev_107094 project.
...
ROOT_URLCONF = 'quiet_rice_dev_107094.urls'
...
WSGI_APPLICATION = 'quiet_rice_dev_107094.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_rice_dev_107094 API",
    "DESCRIPTION": "API documentation for quiet_rice_dev_107094 App",
    "VERSION": "v1",
}
